...
public class CategoryDAO {
	...
	private static final String SELECT_ALL_CATEGORY = "select * from category where enabel=0;";
	...
	private static final String DELETE_BY_ID = "update category SET enabel=1 where id = ?;";
